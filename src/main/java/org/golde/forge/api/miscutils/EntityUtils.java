...
public final class EntityUtils {
    ...
    public static List<Entity> getEntityInRaduis(Class entityIWant, Entity from, double raduis){
    	double xCoord = from.posX;
    	double yCoord = from.posY;
    	double zCoord = from.posZ;
    	World w = from.world;
    ...
    public static List<ItemStack>fromEntityItem(List<EntityItem> listOfItems){
    	List<ItemStack> items = new ArrayList<ItemStack>();
    	for(EntityItem ei:listOfItems){items.add(ei.getEntityItem());}
    	return items;
    }
}
