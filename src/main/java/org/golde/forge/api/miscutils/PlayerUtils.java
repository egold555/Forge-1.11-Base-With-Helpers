...
public final class PlayerUtils {
    ...
    public static String getPlayerNameFromUUID (UUID uuid) {
        ...
        try {
            ...
            System.out.println("Could not get name for " + uuid + " " + exception.getMessage());
    ...
    public static UUID getUUIDFromName (String username) {
        ...
        try {
        	...
        	System.out.println("Could not get name for " + username + " " + exception.getMessage());
        }
    ...
    public static void sendSpamlessMessage(String message){
    	sendSpamlessMessage(random.nextInt(10000), new TextComponentString(message));
    }
